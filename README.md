...
💡 4+ years of experience in Data Engineering and Data Analytics, working on real-world data pipelines and reporting solutions.

🤝 Open to collaborating on data engineering, analytics, and automation projects.

🌱 Currently exploring advanced AWS data architectures, analytics engineering concepts, and ML-powered data use cases.
...
aws | python | sql | powerbi | bigquery | git | github | lambda | s3 | sqs | cloudwatch | postgresql | mysql | pandas | numpy | restapi | jira | confluence | linux | regex | ml-basics
